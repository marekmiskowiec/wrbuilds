...
<h1 style="color: red;">Skill 2</h1>
<video autoplay muted loop playsinline>
  <source src={`../../abilities-videos/${skill}.webm`} type="video/mp4" />
</video>
<p>
Active: Kayle and the target allied champion are Heal power icon healed and gain bonus movement speed for 2 seconds.

Kayle can also self-cast, upon which Celestial Blessing will automatically target the nearest allied champion, prioritizing Health icon lowest health.

Heal:

<span style="color: green;">80</span> / <span style="color: green;">120</span> / <span style="color: green;">
  160
</span> / <span style="color: green;">200</span> (+ 40% AP) Bonus Movement
Speed: 25 / 30 / 35 / 40% (+ 8% per 100 AP)
